...
export const CertCard = ({ cert }: CertProps) => {
    ...
    return (
        <Link href={currentCert.link} target="_blank">
            <div className="flex flex-col gap-y-1 sm:mx-auto" data-aos='fade-up'>
                ...
                <p className="text-xs text-center text-gray">{language === 'en' ? 'Click to more details' : 'Clique para mais detalhes'}</p>
            </div >
        </Link>
    )
}