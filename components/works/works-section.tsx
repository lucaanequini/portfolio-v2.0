...
export const WorksSection = () => {
    ...
    return (
        <>
            <div className="h-screen flex flex-col sm:mt-14 justify-center px-5 lg:px-20 xl:px-40" id='works'>
                <p className="font-bold text-3xl sm:text-5xl text-blue pb-5">
                    {language === 'en' ? 'Works' : 'Trabalhos'}
                </p>
                <div className="flex gap-x-1 items-center justify-center mt-10 sm:hidden">
